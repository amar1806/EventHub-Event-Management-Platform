    ...
    <footer className="bg-gray-800 text-white">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <h3 className="text-sm font-semibold uppercase tracking-wider mb-4">For Attendees</h3>
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/dashboard/attendee/wishlist" className="text-gray-300 hover:text-white text-sm">
                  Wishlist
                </Link>
              </li>
              <li>
          ...
          <div>
            <h3 className="text-sm font-semibold uppercase tracking-wider mb-4">For Organizers</h3>
            <ul className="space-y-2">
              <li>
                <Link href="/dashboard/organizer" className="text-gray-300 hover:text-white text-sm">
                  Dashboard
                </Link>
              </li>
              <li>
                <Link href="/dashboard/organizer/events/create" className="text-gray-300 hover:text-white text-sm">
                  Create Event
                </Link>
              </li>
              <li>
